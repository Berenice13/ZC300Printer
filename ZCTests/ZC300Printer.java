...
public class ZC300Printer {
    ...
    */
    ...
    public boolean isValidOrder(String command) {
        ...
        if (this.innerCommand.equals(ZCPCommand)) {
            ...
            try {
                /* --------------------------------------------------------
                    Establece la conexión usando la IP de la impresora
                -------------------------------------------------------- */
                 /*
                String printerIp = "192.168.1.100";  // Reemplaza por la IP de tu impresora
                int printerPort = 9100;  // El puerto por defecto es 9100

                // Se abre la conexión TCP
                connection = new TcpConnection(printerIp, printerPort);
                connection.open();
    ...
    private static String getTemplateData() {
        return "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n" 
            ...
            + "    <font id=\"3\" name=\"OCR A Extended\" size=\"12\" bold=\"yes\" italic=\"no\" underline=\"no\"/>\n" 
            + "  </fonts>\n" 
            + "  <sides>\n" 
            ...
            + "          <text field=\"name\" font_id=\"2\" x=\"0\" y=\"450\" width=\"0\" height=\"0\" angle=\"0\" color=\"0x000000\"/>\n" // Primera parte del nombre
            + "          <text field=\"name2\" font_id=\"2\" x=\"0\" y=\"510\" width=\"0\" height=\"0\" angle=\"0\" color=\"0x000000\"/>\n" // Segunda parte del nombre
            + "        </print_type>\n" 
            + "      </print_types>\n" 
            + "    </side>\n" 
            ...
            + "      <print_types>\n" 
            + "        <print_type type=\"mono\">\n" 
            + "          <text field=\"securityCode\" font_id=\"3\" x=\"600\" y=\"350\" width=\"0\" height=\"0\" angle=\"0\" color=\"0x000000\"/>\n" // Numero de seguridad
            + "          <text field=\"expirationDate\" font_id=\"3\" x=\"700\" y=\"395\" width=\"0\" height=\"0\" angle=\"0\" color=\"0x000000\"/>\n" //fecha de vencimiento
            + "        </print_type>\n" 
            + "      </print_types>\n" 
